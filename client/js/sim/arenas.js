...
const LAYOUTS = [
  ...
  // ── F13: altri 6 livelli CA originali convertiti (tools/lev2arena.mjs) ──
  {
    id: 'ca-hole-in-one',
    name: 'HOLE-IN-ONE',
    difficulty: 'MEDIUM',
  ...
  {
    id: 'ca-monolithian-canals',
    name: 'MONOLITHIAN-CANALS',
    difficulty: 'MEDIUM',
    theme: 'COOLANT',
    map: [
      '########################################',
